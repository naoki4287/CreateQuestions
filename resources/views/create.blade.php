<x-app-layout>
  <div>
    <div>
      <h1 class="text-white text-center text-3xl mt-20">問題のタイトルを記入してください</h1>
    </div>
    @error('title')
    ...
    <form class="text-center mt-40" action="{{ route('insert') }}" name="create" method="post">
      @csrf
      <input class="w-80 h-8 rounded-lg  placeholder:pl-2 outline-none" type="text" name="title" placeholder="タイトル" value="{{ old('title') }}"><br>
